  ...
  function(add_optiling_ut_modules OP_TILING_MODULE_NAME)
    ...
    target_include_directories(
      ${OP_TILING_MODULE_NAME}_cases_obj PRIVATE ${UT_COMMON_INC} ${GTEST_INCLUDE} ${ASCEND_DIR}/include
                                                 ${ASCEND_DIR}/include/base/context_builder ${ASCEND_DIR}/pkg_inc/op_common ${PROJECT_SOURCE_DIR}/common/inc
                                                 ${ASCEND_DIR}/include/tiling
                                                 ${ASCEND_DIR}/pkg_inc/op_common/op_host ${ASCEND_DIR}/include/toolchain
      )
