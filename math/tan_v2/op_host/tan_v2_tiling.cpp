...
#include "math/tan_v2/op_kernel/tan_v2_tiling_data.h"
#include "math/tan_v2/op_kernel/tan_v2_tiling_key.h"
...
ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, int64_t& totalIdx, ge::DataType& dataType)
{
    ...
    OP_CHECK_IF(
        ...
        OP_LOGE(
            context, "TanV2: inputx,outputz shape dim = %zu,  %zu, should be equal 4",
