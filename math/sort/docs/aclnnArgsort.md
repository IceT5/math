...
- **参数说明：**
  ...
  * self(const aclTensor*)：Device侧的aclTensor，支持空Tensor，支持[非连续的Tensor](common/非连续的Tensor.md)。[数据格式](common/数据格式.md)支持ND。
  ...
  * out(aclTensor*)：Device侧的aclTensor, 数据类型支持INT64。支持空Tensor，支持[非连续的Tensor](common/非连续的Tensor.md)。[数据格式](common/数据格式.md)支持ND。shape和[数据格式](common/数据格式.md)需要与self一致。
