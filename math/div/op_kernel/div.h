...
#include "div_tiling_data.h"
#include "div_tiling_key.h"
...
public:
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const DivTilingData* tilingData);
...
template <typename T>
__aicore__ inline void Div<T>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const DivTilingData* tilingData)
{
...
template <typename T>
__aicore__ inline void Div<T>::CopyIn(int32_t progress)
{
...
template <typename T>
__aicore__ inline void Div<T>::CopyOut(int32_t progress)
{
...
template <typename T>
__aicore__ inline void Div<T>::Compute(int32_t progress)
{
...
template <typename T>
__aicore__ inline void Div<T>::Process()
{
