...
public:
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const MaximumV2TilingData* tilingData);
...
template <typename T>
__aicore__ inline void MaximumV2<T>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const MaximumV2TilingData* tilingData)
{
