...
#include "amul_tiling_data.h"
#include "amul_tiling_key.h"
...
class Amul {
public:
    __aicore__ inline Amul(){};

    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const AmulTilingData* tilingData);
...
template <typename T>
__aicore__ inline void Amul<T>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const AmulTilingData* tilingData)
{
...
template <typename T>
__aicore__ inline void Amul<T>::CopyIn(int32_t progress)
{
...
template <typename T>
__aicore__ inline void Amul<T>::CopyOut(int32_t progress)
{
...
template <typename T>
__aicore__ inline void Amul<T>::Compute(int32_t progress)
{
...
template <typename T>
__aicore__ inline void Amul<T>::Process()
{
