...
#include "xxxx_tiling_data.h"
#include "xxxx_tiling_key.h"
...
class Xxxx {
public:
    __aicore__ inline Xxxx(){};

    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const XxxxTilingData* tilingData);
...
template <typename T>
__aicore__ inline void Xxxx<T>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const XxxxTilingData* tilingData)
{
...
template <typename T>
__aicore__ inline void Xxxx<T>::CopyIn(int32_t progress)
{
...
template <typename T>
__aicore__ inline void Xxxx<T>::CopyOut(int32_t progress)
{
...
template <typename T>
__aicore__ inline void Xxxx<T>::Compute(int32_t progress)
{
...
template <typename T>
__aicore__ inline void Xxxx<T>::Process()
{
