...
int main()
{
    ...
    std::vector<float> selfYHostData(2048, 0);
    ...
    ret = aclnnXxxxGetWorkspaceSize(selfX, selfY, out, &workspaceSize, &executor);
    ...
    ret = aclnnXxxx(workspaceAddr, workspaceSize, executor, stream);
