...
int main()
{
    ...
    std::vector<int64_t> selfXShape = {10};
    std::vector<float> selfXHostData(10, 1.0);
    ...
    // 4. 调用aclnnLogSigmoid第一段接口
    ret = aclnnLogSigmoidGetWorkspaceSize(selfX, out, &workspaceSize, &executor);
