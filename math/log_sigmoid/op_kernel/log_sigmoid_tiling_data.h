...
/*!
 * \file log_sigmoid_tiling_data.h
 * \brief tiling data struct
 */

#ifndef _LOG_SIGMOID_TILING_DATA_H_
#define _LOG_SIGMOID_TILING_DATA_H_
...
namespace optiling {
    struct LogSigmoidCompileInfo {
        ...
        LogSigmoidCompileInfo() : totalCoreNum(0), ubSizePlatForm(0) {}
    };
}

// namespace optiling

struct LogSigmoidTilingData {
    int64_t totalLength;
    int32_t coreNum;
