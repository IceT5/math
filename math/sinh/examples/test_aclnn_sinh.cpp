...
int main()
{
    ...
    LOG_PRINT("aclnnSinhGetWorkspaceSize returned %d, workspaceSize=%llu, executor=%p\n",
          ret, (unsigned long long)workspaceSize, (void*)executor);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnSinhExampleGetWorkspaceSize failed. ERROR: %d\n", ret); return ret);
