...
int main()
{
    ...
    std::vector<int64_t> outShape = {32, 4, 4, 4}; //32, 4, 4, 4
    ...
    // 4. 调用aclnnHardSwish第一段接口
    ret = aclnnHardSwishGetWorkspaceSize(selfX, out, &workspaceSize, &executor);
