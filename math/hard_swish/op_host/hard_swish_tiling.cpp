...
#include "math/hard_swish/op_kernel/hard_swish_tiling_data.h"
#include "math/hard_swish/op_kernel/hard_swish_tiling_key.h"
...
ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, int64_t& totalIdx, ge::DataType& dataType)
{
    ...
    OP_CHECK_IF(
        ...
        OP_LOGE(
            context, "Cosh: inputx, outputz shape dim = %zu, %zu, should be equal 4",
