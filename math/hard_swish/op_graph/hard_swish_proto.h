...
/*!
 * \file hard_swish_proto.h
 * \brief
*/
#ifndef OPS_OP_PROTO_INC_HARD_SWISH_H_
#define OPS_OP_PROTO_INC_HARD_SWISH_H_
...
*Compatible with the TensorFlow operator HardSwish.
*/
REG_OP(HardSwish)
...
#endif // OPS_OP_PROTO_INC_HardSwish_H_