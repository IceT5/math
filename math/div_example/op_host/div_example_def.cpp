...
namespace ops {
class DivExample : public OpDef {
public:
    explicit DivExample(const char* name) : OpDef(name)
    {
        ...
        aicoreConfig.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "div_example");    // 这里制定的值会对应到kernel入口文件名.cpp
        this->AICore().AddConfig("ascend910b", aicoreConfig); // 其他的soc版本补充部分配置项
    }
};
OP_ADD(DivExample); // 添加算子信息库
} // namespace ops