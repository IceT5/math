 ...
 * \brief
 */
#ifndef DIV_EXAMPLE_H
#define DIV_EXAMPLE_H

#include "kernel_operator.h"
#include "kernel_tiling/kernel_tiling.h"
#include "div_example_tiling_data.h"
#include "div_example_tiling_key.h"

namespace NsDivExample {
...
class DivExample {
public:
    __aicore__ inline DivExample(){};

    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const DivExampleTilingData* tilingData);
...
template <typename T>
__aicore__ inline void DivExample<T>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const DivExampleTilingData* tilingData)
{
...
template <typename T>
__aicore__ inline void DivExample<T>::CopyIn(int32_t progress)
{
...
template <typename T>
__aicore__ inline void DivExample<T>::CopyOut(int32_t progress)
{
...
template <typename T>
__aicore__ inline void DivExample<T>::Compute(int32_t progress)
{
    AscendC::LocalTensor<T> xLocal = inputQueueX.DeQue<T>();
    AscendC::LocalTensor<T> yLocal = inputQueueY.DeQue<T>();
    AscendC::LocalTensor<T> zLocal = outputQueueZ.AllocTensor<T>();
    AscendC::Div(zLocal, xLocal, yLocal, tileLength_);
...
template <typename T>
__aicore__ inline void DivExample<T>::Process()
{
