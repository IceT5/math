...
/*!
 * \file div_example_proto.h
 * \brief
 */
#ifndef OPS_OP_PROTO_INC_DivEXAMPLE_H_
#define OPS_OP_PROTO_INC_DivEXAMPLE_H_
...
REG_OP(DivExample)
    ...
    .OP_END_FACTORY_REG(DivExample)

} // namespace ge

#endif // OPS_OP_PROTO_INC_DivEXAMPLE_H_