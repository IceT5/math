...
#include "math/add_v2/op_kernel/add_v2_tiling_data.h"
#include "math/add_v2/op_kernel/add_v2_tiling_key.h"
...
ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, int64_t& totalIdx, ge::DataType& dataType)
{
    ...
    OP_CHECK_IF(
        ...
        OP_LOGE(
            context, "AddV2: inputx,inputy,outputz shape dim = %zu, %zu, %zu, should be equal 4",
