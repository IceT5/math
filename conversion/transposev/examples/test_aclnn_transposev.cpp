...
int main()
{
    ...
    std::vector<int64_t> selfXShape = {2,3,4,5,6,7,8,9};
    std::vector<DataType> selfXHostData(362880, 20);
    ret = CreateAclTensor(selfXHostData, selfXShape, &selfXDeviceAddr, aclDataType::ACL_UINT8, &selfX);
    CHECK_RET(ret == ACL_SUCCESS, return ret);

    aclTensor* selfY = nullptr;
    void* selfYDeviceAddr = nullptr;
    std::vector<int64_t> selfYShape = {8};
    std::vector<int64_t> selfYHostData = {1,0,5,3,4,6,2,7};
    ret = CreateAclTensor(selfYHostData, selfYShape, &selfYDeviceAddr, aclDataType::ACL_INT64, &selfY);
    CHECK_RET(ret == ACL_SUCCESS, return ret);

    aclTensor* out = nullptr;
    void* outDeviceAddr = nullptr;
    std::vector<int64_t> outShape = {2,3,4,5,6,7,8,9};
    std::vector<DataType> outHostData(362880, 1);
    ...
    std::vector<int64_t> outShape0 = {10};
