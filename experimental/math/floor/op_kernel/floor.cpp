...
__global__ __aicore__ void floor(GM_ADDR x, GM_ADDR y, GM_ADDR workspace, GM_ADDR tiling)
{
     REGISTER_TILING_DEFAULT(FloorTilingData);
     GET_TILING_DATA_WITH_STRUCT(FloorTilingData, tilingData, tiling);
     MyFloor::KernelFloor<DTYPE_X,DTYPE_Y> op; 
