...
public:
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR exponent, GM_ADDR y, PowTilingData* tilingData);
...
template <typename TYPE_X, typename TYPE_Y>
__aicore__ inline void KernelPow<TYPE_X, TYPE_Y>::Init(GM_ADDR x, GM_ADDR exponent, GM_ADDR y, PowTilingData* tilingData)
{
