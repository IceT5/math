...
int main()
{
    ...
    ret = aclnnOnesLikeGetWorkspaceSize(selfX, selfY, out, &workspaceSize, &executor);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnOnesLikeGetWorkspaceSize failed. ERROR: %d\n", ret); return ret);
    ...
    ret = aclnnOnesLike(workspaceAddr, workspaceSize, executor, stream);
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnOnesLike failed. ERROR: %d\n", ret); return ret);
