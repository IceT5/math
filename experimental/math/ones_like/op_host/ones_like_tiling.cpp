...
#include "examples/ones_like/op_kernel/ones_like_tiling_data.h"
#include "examples/ones_like/op_kernel/ones_like_tiling_key.h"
...
ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, int64_t& totalIdx, ge::DataType& dataType)
{
    ...
    OP_CHECK_IF(
        ...
        OP_LOGE(
            context, "OnesLike: inputx,inputy,outputz shape dim = %zu, %zu, %zu, should be equal 4",
