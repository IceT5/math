...
public:
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const OnesLikeTilingData* tilingData);
...
template <typename T>
__aicore__ inline void OnesLike<T>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR z, const OnesLikeTilingData* tilingData)
{
...
template <typename T>
__aicore__ inline void OnesLike<T>::CopyIn(int32_t progress)
{
...
template <typename T>
__aicore__ inline void OnesLike<T>::CopyOut(int32_t progress)
{
...
template <typename T>
__aicore__ inline void OnesLike<T>::Compute(int32_t progress)
{
